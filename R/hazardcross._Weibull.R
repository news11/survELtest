...
#'
#' @description The data frame \code{hazardcross_Weibull} is obtained as follows. The survival time 
...
#' }
#' @references H. Chang, I.W. McKeague, "Nonparametric testing for multiple survival functions with non-inferiority margins,"
